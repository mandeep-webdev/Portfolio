...
`,
  },
  {
    title: "Skills",
    content: `
I primarily work with JavaScript and TypeScript, and I build interfaces using React and Next.js. I’m comfortable designing responsive layouts with Tailwind CSS and ensuring cross-browser compatibility.

For state management, I’ve used Redux Toolkit and the Context API. I also have experience working with Node.js and Express for backend integration, especially when dealing with APIs.

I focus a lot on writing clean, modular code and building scalable frontend architectures.
`,
  },
  {
    title: "Projects",
